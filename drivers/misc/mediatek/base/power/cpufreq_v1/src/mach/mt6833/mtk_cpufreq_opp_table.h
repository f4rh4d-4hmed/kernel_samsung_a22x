...
/* FY - MODIFIED FOR OVERCLOCK */
/* for DVFS OPP table L (Little cores) - Max frequency increased to 2200MHz */
#define CPU_DVFS_FREQ0_LL_FY		2200000         /* KHz - OVERCLOCKED */
#define CPU_DVFS_FREQ1_LL_FY		2000000         /* KHz */
#define CPU_DVFS_FREQ2_LL_FY		1916000         /* KHz */
#define CPU_DVFS_FREQ3_LL_FY		1812000		/* KHz */
#define CPU_DVFS_FREQ4_LL_FY		1750000		/* KHz */
#define CPU_DVFS_FREQ5_LL_FY		1645000		/* KHz */
#define CPU_DVFS_FREQ6_LL_FY		1500000		/* KHz */
#define CPU_DVFS_FREQ7_LL_FY		1390000		/* KHz */
#define CPU_DVFS_FREQ8_LL_FY		1280000		/* KHz */
#define CPU_DVFS_FREQ9_LL_FY		1115000		/* KHz */
#define CPU_DVFS_FREQ10_LL_FY		1032000		/* KHz */
#define CPU_DVFS_FREQ11_LL_FY		950000		/* KHz */
#define CPU_DVFS_FREQ12_LL_FY		840000		/* KHz */
#define CPU_DVFS_FREQ13_LL_FY		730000		/* KHz */
...
#define CPU_DVFS_FREQ13_L_FY		985000		/* KHz */
#define CPU_DVFS_FREQ14_L_FY		898000		/* KHz */
#define CPU_DVFS_FREQ15_L_FY		840000		/* KHz */
...
/* for DVFS OPP table L (Little cores) - Voltages increased for overclock stability */
#define CPU_DVFS_VOLT0_VPROC1_FY	105000		/* 10uV - INCREASED FOR OVERCLOCK */
#define CPU_DVFS_VOLT1_VPROC1_FY	100000		/* 10uV */
#define CPU_DVFS_VOLT2_VPROC1_FY	 97500		/* 10uV */
#define CPU_DVFS_VOLT3_VPROC1_FY	 94375		/* 10uV */
#define CPU_DVFS_VOLT4_VPROC1_FY	 92500		/* 10uV */
#define CPU_DVFS_VOLT5_VPROC1_FY	 89375		/* 10uV */
...
#define CPU_DVFS_VOLT9_VPROC1_FY	 76250		/* 10uV */
#define CPU_DVFS_VOLT10_VPROC1_FY	 74375		/* 10uV */
...
/* for DVFS OPP table B (Big cores) - Voltages increased for overclock stability */
#define CPU_DVFS_VOLT0_VPROC2_FY	110000		/* 10uV - INCREASED FOR OVERCLOCK */
#define CPU_DVFS_VOLT1_VPROC2_FY	105000		/* 10uV */
#define CPU_DVFS_VOLT2_VPROC2_FY	101875		/* 10uV */
#define CPU_DVFS_VOLT3_VPROC2_FY	99375		/* 10uV */
#define CPU_DVFS_VOLT4_VPROC2_FY	96875		/* 10uV */
#define CPU_DVFS_VOLT5_VPROC2_FY	93750		/* 10uV */
#define CPU_DVFS_VOLT6_VPROC2_FY	91875		/* 10uV */
#define CPU_DVFS_VOLT7_VPROC2_FY	90000		/* 10uV */
#define CPU_DVFS_VOLT8_VPROC2_FY	86875		/* 10uV */
#define CPU_DVFS_VOLT9_VPROC2_FY	83750		/* 10uV */
#define CPU_DVFS_VOLT10_VPROC2_FY	80000		/* 10uV */
#define CPU_DVFS_VOLT11_VPROC2_FY	75625		/* 10uV */
#define CPU_DVFS_VOLT12_VPROC2_FY	73750		/* 10uV */
#define CPU_DVFS_VOLT13_VPROC2_FY	71875		/* 10uV */
#define CPU_DVFS_VOLT14_VPROC2_FY	69375		/* 10uV */
#define CPU_DVFS_VOLT15_VPROC2_FY	68125		/* 10uV */
...
/* B20G - MODIFIED FOR OVERCLOCK */
/* for DVFS OPP table L (Little cores) */
#define CPU_DVFS_FREQ0_LL_B20G		2200000         /* KHz - OVERCLOCKED */
#define CPU_DVFS_FREQ1_LL_B20G		2000000         /* KHz */
#define CPU_DVFS_FREQ2_LL_B20G		1916000         /* KHz */
#define CPU_DVFS_FREQ3_LL_B20G		1812000		/* KHz */
#define CPU_DVFS_FREQ4_LL_B20G		1750000		/* KHz */
#define CPU_DVFS_FREQ5_LL_B20G		1645000		/* KHz */
#define CPU_DVFS_FREQ6_LL_B20G		1500000		/* KHz */
#define CPU_DVFS_FREQ7_LL_B20G		1390000		/* KHz */
#define CPU_DVFS_FREQ8_LL_B20G		1280000		/* KHz */
#define CPU_DVFS_FREQ9_LL_B20G		1115000		/* KHz */
#define CPU_DVFS_FREQ10_LL_B20G		1032000		/* KHz */
#define CPU_DVFS_FREQ11_LL_B20G		950000		/* KHz */
#define CPU_DVFS_FREQ12_LL_B20G		840000		/* KHz */
#define CPU_DVFS_FREQ13_LL_B20G		730000		/* KHz */
#define CPU_DVFS_FREQ14_LL_B20G		620000		/* KHz */
#define CPU_DVFS_FREQ15_LL_B20G		500000		/* KHz */

/* for DVFS OPP table B (Big cores) */
#define CPU_DVFS_FREQ0_L_B20G		2300000		/* KHz - OVERCLOCKED */
#define CPU_DVFS_FREQ1_L_B20G		2000000		/* KHz */
#define CPU_DVFS_FREQ2_L_B20G		1953000		/* KHz */
#define CPU_DVFS_FREQ3_L_B20G		1906000		/* KHz */
#define CPU_DVFS_FREQ4_L_B20G		1836000		/* KHz */
#define CPU_DVFS_FREQ5_L_B20G		1790000		/* KHz */
#define CPU_DVFS_FREQ6_L_B20G		1720000		/* KHz */
#define CPU_DVFS_FREQ7_L_B20G		1650000		/* KHz */
#define CPU_DVFS_FREQ8_L_B20G		1534000		/* KHz */
#define CPU_DVFS_FREQ9_L_B20G		1418000		/* KHz */
#define CPU_DVFS_FREQ10_L_B20G		1274000		/* KHz */
#define CPU_DVFS_FREQ11_L_B20G		1129000		/* KHz */
#define CPU_DVFS_FREQ12_L_B20G		1042000		/* KHz */
#define CPU_DVFS_FREQ13_L_B20G		985000		/* KHz */
#define CPU_DVFS_FREQ14_L_B20G		898000		/* KHz */
#define CPU_DVFS_FREQ15_L_B20G		840000		/* KHz */
...
/* for DVFS OPP table L (Little cores) - Voltages increased for overclock */
#define CPU_DVFS_VOLT0_VPROC1_B20G	105000		/* 10uV - INCREASED FOR OVERCLOCK */
#define CPU_DVFS_VOLT1_VPROC1_B20G	100000		/* 10uV */
#define CPU_DVFS_VOLT2_VPROC1_B20G	 97500		/* 10uV */
#define CPU_DVFS_VOLT3_VPROC1_B20G	 94375		/* 10uV */
#define CPU_DVFS_VOLT4_VPROC1_B20G	 92500		/* 10uV */
#define CPU_DVFS_VOLT5_VPROC1_B20G	 89375		/* 10uV */
#define CPU_DVFS_VOLT6_VPROC1_B20G	 85000		/* 10uV */
#define CPU_DVFS_VOLT7_VPROC1_B20G	 82500		/* 10uV */
#define CPU_DVFS_VOLT8_VPROC1_B20G	 80000		/* 10uV */
#define CPU_DVFS_VOLT9_VPROC1_B20G	 76250		/* 10uV */
#define CPU_DVFS_VOLT10_VPROC1_B20G	 74375		/* 10uV */
#define CPU_DVFS_VOLT11_VPROC1_B20G	 72500		/* 10uV */
#define CPU_DVFS_VOLT12_VPROC1_B20G	 70000		/* 10uV */
#define CPU_DVFS_VOLT13_VPROC1_B20G	 67500		/* 10uV */
#define CPU_DVFS_VOLT14_VPROC1_B20G	 66250          /* 10uV */
#define CPU_DVFS_VOLT15_VPROC1_B20G	 65000		/* 10uV */

/* for DVFS OPP table B (Big cores) - Voltages increased for overclock */
#define CPU_DVFS_VOLT0_VPROC2_B20G	 104375		/* 10uV - INCREASED FOR OVERCLOCK */
#define CPU_DVFS_VOLT1_VPROC2_B20G	 99375		/* 10uV */
#define CPU_DVFS_VOLT2_VPROC2_B20G	 98125	/* 10uV	*/
#define CPU_DVFS_VOLT3_VPROC2_B20G	 96875	/* 10uV	*/
#define CPU_DVFS_VOLT4_VPROC2_B20G	 95000	/* 10uV	*/
#define CPU_DVFS_VOLT5_VPROC2_B20G	 94375	/* 10uV	*/
#define CPU_DVFS_VOLT6_VPROC2_B20G	 92500	/* 10uV	*/
#define CPU_DVFS_VOLT7_VPROC2_B20G	 90625	/* 10uV	*/
#define CPU_DVFS_VOLT8_VPROC2_B20G	 87500	/* 10uV	*/
#define CPU_DVFS_VOLT9_VPROC2_B20G	 84375	/* 10uV	*/
#define CPU_DVFS_VOLT10_VPROC2_B20G	 80000	/* 10uV	*/
#define CPU_DVFS_VOLT11_VPROC2_B20G	 75625	/* 10uV	*/
#define CPU_DVFS_VOLT12_VPROC2_B20G	 73750	/* 10uV	*/
#define CPU_DVFS_VOLT13_VPROC2_B20G	 72500	/* 10uV	*/
#define CPU_DVFS_VOLT14_VPROC2_B20G	 70000	/* 10uV	*/
#define CPU_DVFS_VOLT15_VPROC2_B20G	 68125	/* 10uV	*/
...
/* B24G - MODIFIED FOR OVERCLOCK */
/* for DVFS OPP table L (Little cores) */
#define CPU_DVFS_FREQ0_LL_B24G		2200000         /* KHz - OVERCLOCKED */
#define CPU_DVFS_FREQ1_LL_B24G		2000000         /* KHz */
#define CPU_DVFS_FREQ2_LL_B24G		1916000         /* KHz */
#define CPU_DVFS_FREQ3_LL_B24G		1812000		/* KHz */
#define CPU_DVFS_FREQ4_LL_B24G		1750000		/* KHz */
#define CPU_DVFS_FREQ5_LL_B24G		1645000		/* KHz */
#define CPU_DVFS_FREQ6_LL_B24G		1500000		/* KHz */
#define CPU_DVFS_FREQ7_LL_B24G		1393000		/* KHz */
#define CPU_DVFS_FREQ8_LL_B24G		1287000		/* KHz */
#define CPU_DVFS_FREQ9_LL_B24G		1128000		/* KHz */
#define CPU_DVFS_FREQ10_LL_B24G		1048000		/* KHz */
#define CPU_DVFS_FREQ11_LL_B24G		968000		/* KHz */
#define CPU_DVFS_FREQ12_LL_B24G		862000		/* KHz */
#define CPU_DVFS_FREQ13_LL_B24G		756000		/* KHz */
#define CPU_DVFS_FREQ14_LL_B24G		703000		/* KHz */
#define CPU_DVFS_FREQ15_LL_B24G		650000		/* KHz */

/* for DVFS OPP table B (Big cores) */
#define CPU_DVFS_FREQ0_L_B24G		2300000		/* KHz - OVERCLOCKED */
#define CPU_DVFS_FREQ1_L_B24G		2400000		/* KHz - KEEP ORIGINAL HIGH FREQ */
#define CPU_DVFS_FREQ2_L_B24G		2306000		/* KHz */
#define CPU_DVFS_FREQ3_L_B24G		2203000		/* KHz */
#define CPU_DVFS_FREQ4_L_B24G		2118000		/* KHz */
#define CPU_DVFS_FREQ5_L_B24G		1993000		/* KHz */
#define CPU_DVFS_FREQ6_L_B24G		1837000		/* KHz */
#define CPU_DVFS_FREQ7_L_B24G		1650000		/* KHz */
#define CPU_DVFS_FREQ8_L_B24G		1534000		/* KHz */
#define CPU_DVFS_FREQ9_L_B24G		1418000		/* KHz */
#define CPU_DVFS_FREQ10_L_B24G		1274000		/* KHz */
#define CPU_DVFS_FREQ11_L_B24G		1129000		/* KHz */
#define CPU_DVFS_FREQ12_L_B24G		1042000		/* KHz */
#define CPU_DVFS_FREQ13_L_B24G		985000		/* KHz */
#define CPU_DVFS_FREQ14_L_B24G		898000		/* KHz */
#define CPU_DVFS_FREQ15_L_B24G		840000		/* KHz */
...
/* for DVFS OPP table L (Little cores) - Voltages increased for overclock */
#define CPU_DVFS_VOLT0_VPROC1_B24G	105000		/* 10uV - INCREASED FOR OVERCLOCK */
#define CPU_DVFS_VOLT1_VPROC1_B24G	100000		/* 10uV */
#define CPU_DVFS_VOLT2_VPROC1_B24G	 97500		/* 10uV */
#define CPU_DVFS_VOLT3_VPROC1_B24G	 94375		/* 10uV */
#define CPU_DVFS_VOLT4_VPROC1_B24G	 92500		/* 10uV */
#define CPU_DVFS_VOLT5_VPROC1_B24G	 89375		/* 10uV */
#define CPU_DVFS_VOLT6_VPROC1_B24G	 85000		/* 10uV */
#define CPU_DVFS_VOLT7_VPROC1_B24G	 82500		/* 10uV */
#define CPU_DVFS_VOLT8_VPROC1_B24G	 80000		/* 10uV */
#define CPU_DVFS_VOLT9_VPROC1_B24G	 76250		/* 10uV */
#define CPU_DVFS_VOLT10_VPROC1_B24G	 74375		/* 10uV */
#define CPU_DVFS_VOLT11_VPROC1_B24G	 72500		/* 10uV */
#define CPU_DVFS_VOLT12_VPROC1_B24G	 70000		/* 10uV */
#define CPU_DVFS_VOLT13_VPROC1_B24G	 67500		/* 10uV */
#define CPU_DVFS_VOLT14_VPROC1_B24G	 66250          /* 10uV */
#define CPU_DVFS_VOLT15_VPROC1_B24G	 65000		/* 10uV */

/* for DVFS OPP table B (Big cores) - Voltages increased for overclock */
#define CPU_DVFS_VOLT0_VPROC2_B24G	 110000		/* 10uV - INCREASED FOR OVERCLOCK */
#define CPU_DVFS_VOLT1_VPROC2_B24G	 105000		/* 10uV	*/
#define CPU_DVFS_VOLT2_VPROC2_B24G	 103125	/* 10uV	*/
#define CPU_DVFS_VOLT3_VPROC2_B24G	 101250	/* 10uV	*/
#define CPU_DVFS_VOLT4_VPROC2_B24G	 99375	/* 10uV	*/
#define CPU_DVFS_VOLT5_VPROC2_B24G	 96875	/* 10uV	*/
#define CPU_DVFS_VOLT6_VPROC2_B24G	 93750	/* 10uV	*/
#define CPU_DVFS_VOLT7_VPROC2_B24G	 90000	/* 10uV	*/
#define CPU_DVFS_VOLT8_VPROC2_B24G	 86875	/* 10uV	*/
#define CPU_DVFS_VOLT9_VPROC2_B24G	 83750	/* 10uV	*/
#define CPU_DVFS_VOLT10_VPROC2_B24G	 80000	/* 10uV	*/
#define CPU_DVFS_VOLT11_VPROC2_B24G	 75625	/* 10uV	*/
#define CPU_DVFS_VOLT12_VPROC2_B24G	 73750	/* 10uV	*/
#define CPU_DVFS_VOLT13_VPROC2_B24G	 71875	/* 10uV	*/
#define CPU_DVFS_VOLT14_VPROC2_B24G	 69375	/* 10uV	*/
#define CPU_DVFS_VOLT15_VPROC2_B24G	 68125	/* 10uV	*/
...
OPP_TBL(LL,   B20G, 1, 1); /* opp_tbl_LL_e1_0   */
OPP_TBL(L,  B20G, 1, 2); /* opp_tbl_L_e1_0  */
OPP_TBL(CCI, B20G, 1, 3); /* opp_tbl_CCI_e1_0 */

OPP_TBL(LL,   B24G, 2, 1); /* opp_tbl_LL_e2_0   */
OPP_TBL(L,  B24G, 2, 2); /* opp_tbl_L_e2_0  */
OPP_TBL(CCI, B24G, 2, 3); /* opp_tbl_CCI_e2_0 */
